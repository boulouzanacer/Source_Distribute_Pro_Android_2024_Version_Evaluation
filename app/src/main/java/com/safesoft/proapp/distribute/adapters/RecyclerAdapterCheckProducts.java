...
//
    ...
    public RecyclerAdapterCheckProducts(Context context, Activity activity, List<PostData_Produit> itemList, String mode_tarif, String name_class) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        if(holder.qte != null) {
            holder.Total_produit.setText(new DecimalFormat("##,##0.00").format(Double.parseDouble(holder.qte.getText().toString()) * Double.parseDouble(holder.Prix_vente.getText().toString())));
            holder.Qte_r.setText(new DecimalFormat("##,##0.00").format(Double.parseDouble(item.stock) - Double.parseDouble(holder.qte.getText().toString())));
        ...
        holder.Increase.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!holder.qte.getText().toString().isEmpty()) {
                    ...
                    if(!stock_moins){
                        if(Double.valueOf(item.stock) <= Double.parseDouble(holder.qte.getText().toString())) {
                            StockOverFlowMessage(Double.parseDouble(holder.qte.getText().toString()) + 1.0);
                            return;
                        }else{
                            holder.qte.setText(String.valueOf(Integer.parseInt(holder.qte.getText().toString()) + 1));
                            holder.Total_produit.setText(new DecimalFormat("##,##0.00").format(Double.parseDouble(holder.qte.getText().toString()) * Double.valueOf(holder.Prix_vente.getText().toString())));
                            holder.Qte_r.setText(new DecimalFormat("##,##0.00").format(Double.parseDouble(item.stock) - Double.parseDouble(holder.qte.getText().toString())));
                        }
                    }else{
                        holder.qte.setText(String.valueOf(Integer.parseInt(holder.qte.getText().toString()) + 1));
                    ...
                    holder.qte.setText("0");
                    holder.Total_produit.setText(new DecimalFormat("##,##0.00").format(0.0 * Double.parseDouble(holder.Prix_vente.getText().toString())));
                    holder.Qte_r.setText(new DecimalFormat("##,##0.00").format(Double.valueOf(item.stock)));
