...
public class ServiceSenderLocation extends Service {
    ...
    private void getLocationAndSend() {
        ...
        fusedLocationClient.getLastLocation().addOnSuccessListener(location -> {
            if (location != null) {
                Log.e("LOCATION 1", location.getLatitude() + " / " + location.getLongitude());
                LocationSender.sendLocation(deviceId, location.getLatitude(), location.getLongitude(), device_name, 0, 0,0,0, this);
            }
        });
    }
        ...
        fusedLocationClient.requestLocationUpdates(locationRequest, new LocationCallback() {
            ...
            public void onLocationResult(@NonNull LocationResult locationResult) {
                ...
                if (location != null) {
                    ...
                    LocationSender.sendLocation(deviceId, location.getLatitude(), location.getLongitude(), device_name, 0, 0,0,0,  mContext);
                }
