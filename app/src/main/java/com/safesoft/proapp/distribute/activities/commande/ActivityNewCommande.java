...
public class ActivityNewCommande extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if(savedInstanceState != null){
      ...
      if(restoredBarcode != null){
        ...
        Toast.makeText(ActivityNewCommande.this, ""+restoredBarcode.rawValue, Toast.LENGTH_SHORT).show();
  ...
  private void initViews() {
    ...
    rtvl_client = (RelativeLayout) findViewById(R.id.relativeLayout);
    client = (TextView) findViewById(R.id.client);
    addProduct = (Button) findViewById(R.id.addProduct);
    addClient = (Button) findViewById(R.id.btn_create);
    ...
    observation = (TextView) findViewById(R.id.observation_value);
    ...
    switch (v.getId()){
      ...
      case R.id.addProduct:
        if(client.getText().length() <1){
          ...
          Crouton.makeText(ActivityNewCommande.this, "Vous devez Séléctionner un client tout d'abord", Style.ALERT).show();
          return;
        }
        Intent intentAddProduct = new Intent(ActivityNewCommande.this, ActivityAddProduct_Commande.class);
      ...
      case R.id.btn_create:
        Intent intentAddClient = new Intent(ActivityNewCommande.this, ActivityNewClient.class);
        startActivityForResult(intentAddClient, REQUEST_ACTIVITY_NEW_CLIENT);
        break;
      case R.id.valide_facture:
        if(client.getText().length() <1){

          Crouton.makeText(ActivityNewCommande.this, "Vous devez Séléctionner un client", Style.ALERT).show();
          return;
        }
        if(final_panier.size() <1){
          Crouton.makeText(ActivityNewCommande.this, "Panier Vide! Séléctionner un produit", Style.INFO).show();
          return;
        }
/*
                Intent versement_intent = new Intent(ActivityNewCommande.this, ActivityVersement.class);
...
*/
        ...
        if(!controller.check_if_bon1_valide("Bon1_temp", bon1.num_bon)){
          new SweetAlertDialog(ActivityNewCommande.this, SweetAlertDialog.NORMAL_TYPE)
                  ...
                  .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                    ...
                    public void onClick(SweetAlertDialog sDialog) {
                      ...
                      if(controller.update_bon1_temp(bon1.num_bon, bon1)){
                        new SweetAlertDialog(ActivityNewCommande.this, SweetAlertDialog.SUCCESS_TYPE)
                        ...
                        new SweetAlertDialog(ActivityNewCommande.this, SweetAlertDialog.ERROR_TYPE)
                                .setTitleText("Oops...")
          ...
          new SweetAlertDialog(ActivityNewCommande.this, SweetAlertDialog.WARNING_TYPE)
  ...
  protected void initData(){
    ...
    final_panier = controller.select_bon2_from_database("" +
            ...
            "WHERE Bon2_temp.NUM_BON = '" + bon1.num_bon + "'" );
    ...
    switch(item.getItemId()) {
      case R.id.delete:
        ...
        try{
          ...
          PanierAdapter = new ListViewAdapterPanier(ActivityNewCommande.this, R.layout.transfert2_items, final_panier);
          expandableListView.setAdapter(PanierAdapter);
          calcule();
  ...
  private void startScan() {
    ...
    final MaterialBarcodeScanner materialBarcodeScanner = new MaterialBarcodeScannerBuilder()
            .withActivity(ActivityNewCommande.this)
            ...
            .withResultListener(new MaterialBarcodeScanner.OnResultListener() {
              ...
              public void onResult(Barcode barcode) {
                ...
                Toast.makeText(ActivityNewCommande.this, ""+barcode.rawValue, Toast.LENGTH_SHORT).show();
                ...
                if(client.client != null){
                  ...
                  Crouton.makeText(ActivityNewCommande.this, "Client non exist sur le terminal", Style.ALERT).show();
                }
              }
            })
            .build();
