package com.safesoft.proapp.distribute.util;
...
public class MyCardView_Situation extends RelativeLayout {
  ...
  public MyCardView_Situation(Context context) {
    super(context);
    initialize(context);
  ...
  private void initialize(Context context) {
    View root = inflate(context, R.layout.item_list_situation, this);
