...
public class JobService extends android.app.job.JobService {
    ...
    private void registerRestarterReceiver() {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                ContextCompat.registerReceiver(getApplicationContext(), restartBroadcastReceiver, filter, ContextCompat.RECEIVER_NOT_EXPORTED);
            }
        }, 1000);
    }
    ...
    public boolean onStopJob(JobParameters jobParameters) {
        ...
        Intent broadcastIntent = new Intent(Globals.RESTART_INTENT).setPackage(/* TODO: provide the application ID. For example: */ getPackageName());
