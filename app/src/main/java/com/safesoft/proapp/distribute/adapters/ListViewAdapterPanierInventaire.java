...
public class ListViewAdapterPanierInventaire extends ArrayAdapter<PostData_Inv2> {
  ...
  public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
    ...
    if (convertView == null) {
      ...
      viewHolder.qte_theorique = (TextView) convertView.findViewById(R.id.qte_theorique);
      viewHolder.lettre_minus = (TextView) convertView.findViewById(R.id.lettre_minus);
      viewHolder.qte_physique = (TextView) convertView.findViewById(R.id.qte_physique);
      viewHolder.ecart = (TextView) convertView.findViewById(R.id.ecart);
      viewHolder.lettre_equall = (TextView) convertView.findViewById(R.id.lettre_equal);
      viewHolder.lettre_x = (TextView) convertView.findViewById(R.id.lettre_x);
      viewHolder.pa_ht = (TextView) convertView.findViewById(R.id.puv);
