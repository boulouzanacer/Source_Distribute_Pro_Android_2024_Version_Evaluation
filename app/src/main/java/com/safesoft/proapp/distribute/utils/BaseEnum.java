...
public class BaseEnum {
    ...
    public static final int IMP_TYPE_TICKET = 1, IMP_TYPE_CODEBARRE = 2;
    public static final int TICKET_LANGUE_LATIN = 1, TICKET_LANGUE_ARABE = 2;
    public static final int TICKET_CODEBARRE_50X30 = 1, TICKET_CODEBARRE_40X20 = 2, TICKET_CODEBARRE_40X20_WITHOUT_CODEBARRE = 3;
    public static final int TICKET_LATIN_MODEL_1 = 1, TICKET_LATIN_MODEL_2 = 2, TICKET_ARABE_MODEL_1 = 3, TICKET_ARABE_MODEL_2 = 4;
