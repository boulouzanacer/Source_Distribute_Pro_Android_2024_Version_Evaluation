...
public class PrinterVente {
    ...
    public void start_print_sale_bon(Activity activity, ArrayList<PostData_Bon2> final_panier, PostData_Bon1 bon1)  throws UnsupportedEncodingException {
    ...
    public void start_print_order_bon(Activity activity, ArrayList<PostData_Bon2> final_panier, PostData_Bon1 bon1_temp)  throws UnsupportedEncodingException {

        mActivity = activity;
        this.final_panier = final_panier;
        this.bon1 = bon1_temp;
        this.type_print = "ORDER";
