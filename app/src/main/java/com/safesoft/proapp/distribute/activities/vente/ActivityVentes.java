...
public class ActivityVentes extends AppCompatActivity implements RecyclerAdapterBon1.ItemClick, RecyclerAdapterBon1.ItemLongClick {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Les ventes");
            ...
            if (!bt.isBluetoothEnabled()) {
                ...
                bt.setBluetoothConnectionListener(new BluetoothSPP.BluetoothConnectionListener() {
                    ...
                    public void onDeviceDisconnected() {
                        if (progressDialog_wait_connecte != null && !ActivityVentes.this.isFinishing()) {
                            progressDialog_wait_connecte.dismiss();
                            progressDialog_wait_connecte = null;
                        }
                        Crouton.makeText(ActivityVentes.this, "Imprimente bluetooth non connecté ", Style.ALERT).show();
                    }
                    ...
                    public void onDeviceConnectionFailed() {
                        ...
                        Crouton.makeText(ActivityVentes.this, "Imprimente connection erroné ", Style.ALERT).show();
                    }
                    ...
                    public void onDeviceConnected(String name, String address) {
                        ...
                        Crouton.makeText(ActivityVentes.this, "Imprimente connecté à  " + name, Style.CONFIRM).show();
    ...
    private void setRecycle() {
        ...
        adapter = new RecyclerAdapterBon1(this, getItems());
    ...
    public void onClick(View v, int position) {
        ...
        if (bon1s.get(position).blocage.equals("F")) {
            Intent intent = new Intent(ActivityVentes.this, ActivityBon2.class);
            intent.putExtra("NUM_BON", bon1s.get(position).num_bon);
            startActivity(intent);
        } else {
            Intent editIntent = new Intent(ActivityVentes.this, ActivityEditSale.class);
    ...
    protected void Print_bon(String num_bon) {
        ...
        bon1_print = controller.select_bon1_from_database2("" +
                ...
                "Client.CLIENT, " +
                "Client.CREDIT_LIMIT, " +
                "Bon1.ANCIEN_SOLDE AS ANCIEN_SOLDE " +
                "FROM Bon1,Client " +
                "WHERE " +
                "Bon1.CODE_CLIENT = Client.CODE_CLIENT " +
                "AND " +
        ...
        if (printer_mode_integrate) {
            ...
            if (bt.getServiceState() == BluetoothState.STATE_CONNECTED) {
                // print
                Toast.makeText(ActivityVentes.this, " Imprission ...", Toast.LENGTH_SHORT).show();
                prepareBon_Bluetooth();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == BluetoothState.REQUEST_CONNECT_DEVICE) {
            if (resultCode == Activity.RESULT_OK) {
                bt.connect(data);
                progressDialog_wait_connecte = ProgressDialog.show(ActivityVentes.this, getString(R.string.bl_dy1), getString(R.string.printing_wait1));
            }
    ...
    protected void prepareBon_IntegratePrinter() {
        ...
        handler_Integrate = new ActivityVentes.MyHandler_Integrate();
        if (LowBattery) {
            handler_Integrate.sendMessage(handler_Integrate.obtainMessage(LOWBATTERY, 1, 0, null));
        } else {
            if (!nopaper) {
                progressDialog = ProgressDialog.show(ActivityVentes.this, getString(R.string.bl_dy), getString(R.string.printing_wait));
                handler_Integrate.sendMessage(handler_Integrate.obtainMessage(PRINTCONTENT, 1, 0, null));
            } else {
                Toast.makeText(ActivityVentes.this, getString(R.string.ptintInit), Toast.LENGTH_LONG).show();
            }
        }
    }
    ...
    protected void prepareBon_Bluetooth() {
        ...
        handler_Bluetooth = new ActivityVentes.MyHandler_Bluetooth();
        if (LowBattery) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            ...
            startActivityForResult(new Intent(ActivityVentes.this, ActivityNewSale.class), 5000);
        }
    ...
    private class contentPrintThread_Integrate extends Thread {
        ...
        public void run() {
            ...
            try {
                ThermalPrinter.start(ActivityVentes.this);
                ...
                for (int b = 0; b < bon2_print.size(); b++) {
                    ...
                    String prix_u = nf.format(Double.valueOf(bon2_print.get(b).p_u));
                    String total_produit = nf.format(Double.parseDouble(bon2_print.get(b).p_u) * Double.parseDouble(bon2_print.get(b).qte));
                ...
                String walk = "";
                String total_ht = "TOTAL HT : " + nf.format(Double.valueOf(bon1_print.tot_ht)) + " DA";
                ...
                walk = "";
                String tva = "TVA : " + nf.format(Double.valueOf(bon1_print.tot_tva)) + " DA";
                ...
                if (bon1_print.timbre_ckecked) {
                    walk = "";
                    String timbre = "TIMBRE : " + nf.format(Double.valueOf(bon1_print.timbre)) + " DA";
                ...
                walk = "";
                String total_ttc = "TOTAL TTC : " + nf.format(Double.valueOf(bon1_print.tot_ttc)) + " DA";
                ...
                if (bon1_print.remise_ckecked) {
                    ...
                    walk = "";
                    String remise = "REMISE : " + nf.format(Double.valueOf(bon1_print.remise)) + " DA";
                    ...
                    walk = "";
                    String total_ttc_apres_remise = "MONTANT BON : " + nf.format(Double.valueOf(bon1_print.tot_ttc_remise)) + " DA";
                ...
                ThermalPrinter.printString();
                walk = "";
                String Anciensolde = "ANCIEN SOLDE : " + nf.format(Double.valueOf(bon1_print.solde_ancien)) + " DA";
                ...
                if (bon1_print.remise_ckecked) {
                    ...
                    walk = "";
                    String total_ttc_apres_remise = "MONTANT BON : " + nf.format(Double.valueOf(bon1_print.tot_ttc)) + " DA";
                    for (int a = 0; a < 32 - total_ttc_apres_remise.length(); a++) {
                        walk = walk + " ";
                    }
                    ThermalPrinter.addString(walk + total_ttc_apres_remise);
                ...
                walk = "";
                String Actuelsolde = "SOLDE ACTUEL: " + nf.format(Double.parseDouble(bon1_print.solde_ancien) + Double.parseDouble(bon1_print.montant_bon)) + " DA";
                ...
                ThermalPrinter.stop(ActivityVentes.this);
            }
        }
    }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case NOPAPER:
                    ...
                    break;
                case LOWBATTERY:
                    AlertDialog.Builder alertDialog = new AlertDialog.Builder(ActivityVentes.this);
                ...
                case PRINTVERSION:
                    ...
                    if (msg.obj.equals("1")) {
                        ...
                        Toast.makeText(ActivityVentes.this, "Operation failed", Toast.LENGTH_LONG).show();
                    }
                    break;
                case PRINTCONTENT:
                    new ActivityVentes.contentPrintThread_Integrate().start();
                    break;
                case PRINTPICTURE:
                    //   new printPicture().start();
                    break;
                case CANCELPROMPT:
                    if (progressDialog != null && !ActivityVentes.this.isFinishing()) {
                        progressDialog.dismiss();
                        progressDialog = null;
                    }
                    break;
                case OVERHEAT:
                    AlertDialog.Builder overHeatDialog = new AlertDialog.Builder(ActivityVentes.this);
                    ...
                    break;
                default:
                    Toast.makeText(ActivityVentes.this, "Print Error!", Toast.LENGTH_LONG).show();
                    break;
            }
        }
    }
    ...
    private void noPaperDlg() {
        AlertDialog.Builder dlg = new AlertDialog.Builder(ActivityVentes.this);
        dlg.setTitle(getString(R.string.noPaper));
        dlg.setMessage(getString(R.string.noPaperNotice));
        dlg.setCancelable(false);
        dlg.setPositiveButton(R.string.sure, (dialogInterface, i) -> ThermalPrinter.stop(ActivityVentes.this));
        dlg.show();
    }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case PRINTVERSION:
                    ...
                    break;
                case PRINTCONTENT:
                    new ActivityVentes.contentPrintThread_Bluetooth().start();
                    break;
                case CANCELPROMPT:
                    if (progressDialog != null && !ActivityVentes.this.isFinishing()) {
                        progressDialog.dismiss();
    ...
    private class contentPrintThread_Bluetooth extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                bt.send(format, true);
                bt.send("CLIENT : " + bon1_print.client, true);

                bt.send("CODE CLIENT : " + bon1_print.code_client, true);
                bt.send("          ************", true);
                ...
                for (int b = 0; b < bon2_print.size(); b++) {
                    ...
                    String quantite = bon2_print.get(b).qte;
                    String prix_u = nf.format(Double.parseDouble(bon2_print.get(b).p_u) + (Double.parseDouble(bon2_print.get(b).p_u) * (Double.parseDouble(bon2_print.get(b).tva) / 100.0)));
                    String total_produit = nf.format((Double.parseDouble(bon2_print.get(b).p_u) + (Double.parseDouble(bon2_print.get(b).p_u) * (Double.parseDouble(bon2_print.get(b).tva) / 100.0))) * Double.parseDouble(bon2_print.get(b).qte));
                ...
                walk = "";
                Double current_solde = (Double.parseDouble(bon1_print.solde_ancien) + Double.parseDouble(bon1_print.montant_bon));
                ...
                bt.send("------------------------------------------------", true);
                String PREFS_FOOTER = "Footer";
                prefs = getSharedPreferences(PREFS_FOOTER, MODE_PRIVATE);
                if (prefs.getBoolean("FOOTER", false)) {
                    bt.send(right, true);


                    bt.send(Objects.requireNonNull(prefs.getString("MERCI", "")).toUpperCase(), true);
                    bt.send(left, true);
                    format[2] = ((byte) (0x1 | arrayOfByte1[2]));
                    bt.send(format, true);
