...
public class CheckEmailExist extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... params) {
        ...
        String param_geneated_number = params[2]; // parameter geneated_number
        ...
        try {
            ...
            String postParameters = "email=" + param_email + "& geneated_number=" + param_geneated_number;
    ...
    protected void onPostExecute(String result) {
        ...
        try {
            ...
            EventBus.getDefault().post(new CheckEmailEvent(jsonObject.getInt("code"), jsonObject.getBoolean("is_exist"), jsonObject.getBoolean("is_e_sent"), jsonObject.getString("message"), jsonObject.getString("generated_code")));
