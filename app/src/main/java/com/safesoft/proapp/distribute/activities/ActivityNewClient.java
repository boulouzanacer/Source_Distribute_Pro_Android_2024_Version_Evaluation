...
*/
        ...
        if(CODE_DEPOT.equals("000000")){
            new_client.code_client = TimeUnit.MILLISECONDS.toSeconds(System.currentTimeMillis()) +"_"+ CODE_VENDEUR+"";

        }else{
            new_client.code_client = TimeUnit.MILLISECONDS.toSeconds(System.currentTimeMillis()) +"_"+ CODE_DEPOT+"";
