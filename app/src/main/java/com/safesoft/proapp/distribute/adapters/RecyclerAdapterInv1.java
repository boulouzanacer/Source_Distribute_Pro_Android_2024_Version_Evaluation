...
public class RecyclerAdapterInv1 extends RecyclerView.Adapter<RecyclerAdapterInv1.MyViewHolder> {
  ...
  class MyViewHolder extends RecyclerView.ViewHolder {
    ...
    MyViewHolder(View view) {
      ...
      NumInv = (TextView) view.findViewById(R.id.num_inv);
      NomInventaire = (TextView) view.findViewById(R.id.nom_inv);
      Date_exp = (TextView) view.findViewById(R.id.date_exp);
      nbrProduit = (TextView) view.findViewById(R.id.nbr_p);
      Date_inv = (TextView) view.findViewById(R.id.date_inv);
 ...
 */
    ...
    if (color == 0){
      if (generator!=null)
        color = generator.getColor(inv1List.get(position).num_inv);
    }
  }
