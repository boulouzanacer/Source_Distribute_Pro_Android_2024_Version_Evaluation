...
public class RecyclerAdapter_Situation_client extends RecyclerView.Adapter<RecyclerAdapter_Situation_client.MyViewHolder> {
    ...
    public RecyclerAdapter_Situation_client(Context context, List<PostData_Carnet_c> itemList) {
