package com.safesoft.proapp.distribute.dialog;
...
public class BluetoothDeviceChooseDialog extends DialogFragment {
        ...
        tvSearchDevice.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mSearchInited) {
                    ...
                    foundDeviceAdapter = new BluetoothDeviceAdapter(mContext, mactivity, foundDeviceList);
    ...
    private void initData() {
        ...
        pairedDeviceAdapter = new BluetoothDeviceAdapter(mContext, mactivity, pairedDeviceList);
