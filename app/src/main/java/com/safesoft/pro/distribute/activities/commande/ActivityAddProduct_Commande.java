...
import com.safesoft.pro.distribute.adapters.RecyclerProduitCommande;
...
public class ActivityAddProduct_Commande extends AppCompatActivity implements RecyclerProduitCommande.ItemClick{

  RecyclerView recyclerView;
  RecyclerProduitCommande adapter;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if(savedInstanceState != null){
      ...
      if(restoredBarcode != null){
        ...
        Toast.makeText(ActivityAddProduct_Commande.this, ""+restoredBarcode.rawValue, Toast.LENGTH_SHORT).show();
  ...
  private void setRecycle(String text_search, Boolean isScan) {
    ...
    adapter = new RecyclerProduitCommande(this, ActivityAddProduct_Commande.this, getItems(text_search, isScan), mode_tariff_client, "2");
  ...
  public void onMessageRecieve(MessageEvent event){
    final Style ALERTT = new Style.Builder()
            ...
            .build();
    Crouton.makeText(ActivityAddProduct_Commande.this, "" + event.getMessage(), ALERTT).show();
  }
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    if(item.getItemId() == android.R.id.home){
      ...
      for(int h = 0; h < final_panier.size(); h++){
        controller.Insert_into_bon2_temp("Bon2_temp", NUM_BON, CODE_DEPOT, final_panier.get(h));
      }
  ...
  private void startScan() {
    ...
    final MaterialBarcodeScanner materialBarcodeScanner = new MaterialBarcodeScannerBuilder()
            .withActivity(ActivityAddProduct_Commande.this)
            ...
            .withResultListener(new MaterialBarcodeScanner.OnResultListener() {
              ...
              public void onResult(Barcode barcode) {
                ...
                Toast.makeText(ActivityAddProduct_Commande.this, ""+barcode.rawValue, Toast.LENGTH_SHORT).show();
