...
import com.safesoft.pro.distribute.activities.vente.ActivityBon2;
import com.safesoft.pro.distribute.activities.vente.ActivityEditSale;
import com.safesoft.pro.distribute.adapters.RecyclerAdapterBon1;
...
public class ActivityExportedVentes extends AppCompatActivity implements RecyclerAdapterBon1.ItemClick , RecyclerAdapterBon1.ItemLongClick{
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    bt.setBluetoothConnectionListener(new BluetoothSPP.BluetoothConnectionListener() {
      ...
      public void onDeviceDisconnected() {
        if (progressDialog_wait_connecte != null && !ActivityExportedVentes.this.isFinishing()) {
          progressDialog_wait_connecte.dismiss();
          progressDialog_wait_connecte = null;
        }
        Crouton.makeText(ActivityExportedVentes.this, "Imprimente bluetooth non connecté ", Style.ALERT).show();
      }
      ...
      public void onDeviceConnectionFailed() {
        ...
        Crouton.makeText(ActivityExportedVentes.this, "Imprimente connection erroné ", Style.ALERT).show();
      }
      ...
      public void onDeviceConnected(String name, String address) {
        ...
        Crouton.makeText(ActivityExportedVentes.this, "Imprimente connecté à  "+ name, Style.CONFIRM).show();
  ...
  public ArrayList<PostData_Bon1> getItems() {
    ...
    String querry = "SELECT " +
            ...
            "WHERE Bon1.IS_EXPORTED = 1 ORDER BY Bon1.DATE_BON DESC";
  ...
  public void onClick(View v, int position) {
    ...
    if(bon1s.get(position).blocage.equals("F")){
      ...
      Intent editIntent = new Intent(ActivityExportedVentes.this, ActivityEditSale.class);
  ...
  protected void Print_bon(String num_bon){
    ...
    if(printer_mode_integrate){
      ...
      if(bt.getServiceState() == BluetoothState.STATE_CONNECTED){
        // print
        Toast.makeText(ActivityExportedVentes.this, " Imprission ..." , Toast.LENGTH_SHORT).show();
        prepareBon_Bluetooth();
  ...
  public void onActivityResult(int requestCode, int resultCode, Intent data) {
    if(requestCode == BluetoothState.REQUEST_CONNECT_DEVICE) {
      if(resultCode == Activity.RESULT_OK){
        bt.connect(data);
        progressDialog_wait_connecte = ProgressDialog.show(ActivityExportedVentes.this, getString(R.string.bl_dy1), getString(R.string.printing_wait1));
      }
  ...
  protected void prepareBon_IntegratePrinter(){
    ...
    handler_Integrate = new ActivityExportedVentes.MyHandler_Integrate();
    if (LowBattery == true) {
      handler_Integrate.sendMessage(handler_Integrate.obtainMessage(LOWBATTERY, 1, 0, null));
    } else {
      if (!nopaper) {
        progressDialog = ProgressDialog.show(ActivityExportedVentes.this, getString(R.string.bl_dy), getString(R.string.printing_wait));
        handler_Integrate.sendMessage(handler_Integrate.obtainMessage(PRINTCONTENT, 1, 0, null));
      } else {
        Toast.makeText(ActivityExportedVentes.this, getString(R.string.ptintInit), Toast.LENGTH_LONG).show();
      }
    }
  }
  ...
  protected void prepareBon_Bluetooth(){
    ...
    handler_Bluetooth = new ActivityExportedVentes.MyHandler_Bluetooth();
    if (LowBattery == true) {
  ...
  private class contentPrintThread_Integrate extends Thread {
    ...
    public void run() {
      ...
      try {
        ThermalPrinter.start(ActivityExportedVentes.this);
        ...
        for(int b= 0; b<bon2_print.size(); b++){
          ...
          String total_produit = nf.format(Double.valueOf(bon2_print.get(b).p_u) * Double.valueOf(bon2_print.get(b).qte));
        ...
        walk ="";
        String tva = "TVA : "  + nf.format(Double.valueOf(bon1_print.tot_tva.toString()))+ " DA";
        ...
        walk ="";
        String Actuelsolde = "SOLDE ACTUEL: "  +  nf.format(Double.valueOf(bon1_print.solde_ancien) + Double.valueOf(bon1_print.montant_bon)) + " DA";
        ...
        ThermalPrinter.stop(ActivityExportedVentes.this);
      }
    }
  }
    ...
    public void handleMessage(Message msg) {
      switch (msg.what) {
        case NOPAPER:
          ...
          break;
        case LOWBATTERY:
          AlertDialog.Builder alertDialog = new AlertDialog.Builder(ActivityExportedVentes.this);
        ...
        case PRINTVERSION:
          ...
          if (msg.obj.equals("1")) {
            ...
            Toast.makeText(ActivityExportedVentes.this, "Operation failed", Toast.LENGTH_LONG).show();
          }
          break;
        case PRINTCONTENT:
          new ActivityExportedVentes.contentPrintThread_Integrate().start();
          break;
        case PRINTPICTURE:
          //   new printPicture().start();
          break;
        case CANCELPROMPT:
          if (progressDialog != null && !ActivityExportedVentes.this.isFinishing()) {
            progressDialog.dismiss();
            progressDialog = null;
          }
          break;
        case OVERHEAT:
          AlertDialog.Builder overHeatDialog = new AlertDialog.Builder(ActivityExportedVentes.this);
          ...
          break;
        default:
          Toast.makeText(ActivityExportedVentes.this, "Print Error!", Toast.LENGTH_LONG).show();
          break;
      }
    }
  }
  ...
  private void noPaperDlg() {
    AlertDialog.Builder dlg = new AlertDialog.Builder(ActivityExportedVentes.this);
    ...
    public void handleMessage(Message msg) {
      switch (msg.what) {
        case PRINTVERSION:
          ...
          break;
        case PRINTCONTENT:
          new ActivityExportedVentes.contentPrintThread_Bluetooth().start();
          break;
        case CANCELPROMPT:
          if (progressDialog != null && !ActivityExportedVentes.this.isFinishing()) {
            progressDialog.dismiss();
  ...
  private class contentPrintThread_Bluetooth extends Thread {
    ...
    public void run() {
      ...
      try {
        ...
        format[2] = ((byte) (0x20 | arrayOfByte1[2]));
        bt.send(format, true);
        bt.send("        BON DE VENTE", true);
        bt.send("          "+bon1_print.num_bon, true);
        //bt.send("------------------------------------------------", true);
        ...
        bt.send("DATE HEURE : " + bon1_print.date_bon + " " + bon1_print.heure, true);
        bt.send("------------------------------------------------", true);
