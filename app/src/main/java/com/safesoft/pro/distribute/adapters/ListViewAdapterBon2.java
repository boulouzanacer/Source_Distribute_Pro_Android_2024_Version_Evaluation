...
public class ListViewAdapterBon2 extends ArrayAdapter<PostData_Bon2> {
  ...
  public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
    ...
    if (convertView == null) {
      ...
      viewHolder.prix_u = (TextView) convertView.findViewById(R.id.prix_u);
    ...
    viewHolder.prix_u.setText(new DecimalFormat("##,##0.00").format(Double.valueOf(bon2.p_u.toString())));
