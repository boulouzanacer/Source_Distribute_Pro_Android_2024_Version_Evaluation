...
import com.safesoft.pro.distribute.activities.ActivityVersement;
...
public class ActivityNewSale extends AppCompatActivity {
    ...
    public void calcule(){
        ...
        if(checkBox_remise.isChecked() && checkBox_timbre.isChecked()){
            ...
            final BadgeDrawable drawable0 =
                    new BadgeDrawable.Builder()
                            ...
                            .text1(nf.format(Double.valueOf(val_total_ttc_remise.toString())))
                            .text2(" DA")
                            .build();
            ...
            final BadgeDrawable drawable1 =
                    new BadgeDrawable.Builder()
                            ...
                            .text1(nf.format(Double.valueOf(val_timbre.toString())))
                            .text2(" DA")
                            .build();
        ...
        final BadgeDrawable drawable3 = new BadgeDrawable.Builder()
                .type(BadgeDrawable.TYPE_WITH_TWO_TEXT_COMPLEMENTARY)
                .badgeColor(0xff303F9F)
                .text1(nf.format(Double.valueOf(val_total_ht.toString())))
                .text2(" DA ")
                .build();
        ...
        final BadgeDrawable drawable4 = new BadgeDrawable.Builder()
                .type(BadgeDrawable.TYPE_WITH_TWO_TEXT_COMPLEMENTARY)
                .badgeColor(0xffE74C3C)
                .text1(nf.format(Double.valueOf(val_tva.toString())))
                .text2(" DA ")
                .build();
        SpannableString spannableString4 = new SpannableString(TextUtils.concat(drawable4.toSpannable()));
        ...
        final BadgeDrawable drawable5 = new BadgeDrawable.Builder()
                .type(BadgeDrawable.TYPE_WITH_TWO_TEXT_COMPLEMENTARY)
                .badgeColor(0xff303F9F)
                .text1(nf.format(Double.valueOf(val_total_ttc.toString())))
                .text2(" DA ")
                .build();
