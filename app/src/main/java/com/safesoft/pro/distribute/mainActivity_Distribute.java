...
import com.safesoft.pro.distribute.activities.inventaire.ActivityInventaire;
...
public class mainActivity_Distribute extends Fragment implements View.OnClickListener{
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    BtnVente  = (ImageButton) v.findViewById(R.id.btnventes);
      BtnBonReception= (ImageButton) v.findViewById(R.id.btn_b_reception);
    BtnProduit= (ImageButton) v.findViewById(R.id.btnproduits);
    BtnClient= (ImageButton) v.findViewById(R.id.btnclients);
    BtnImportExport= (ImageButton) v.findViewById(R.id.btnimport_export);
      BtnCommande= (ImageButton) v.findViewById(R.id.btncommande);
    BtnInventaireAchat= (ImageButton) v.findViewById(R.id.btn_inventaire_achat);
    BtnParametre= (ImageButton) v.findViewById(R.id.btnparametres);
  ...
  public void onClick(View v){
    ...
    mp = MediaPlayer.create(getActivity(), R.raw.pellet);
    mp.start();
